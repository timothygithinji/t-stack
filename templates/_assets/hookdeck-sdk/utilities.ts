...
export async function getPackage(): Promise<string | undefined> {
  if (_packageRef === undefined) {
    ...
    if (_packageRef === undefined) {
      ...
      params.setName("hookdeck");
      params.setVersion("2.2.1");
      params.setValue(
        Uint8Array.from(
          atob(
            "eyJyZW1vdGUiOnsidXJsIjoicmVnaXN0cnkub3BlbnRvZnUub3JnL2hvb2tkZWNrL2hvb2tkZWNrIiwidmVyc2lvbiI6IjIuMi4xIn19"
          ),
          (c) => c.charCodeAt(0)
        )
      );
